...
import { 
  Search, Plus, X, Eye, Edit2, Trash2, Upload, Calendar, 
...
const printViaIframe = (content: string) => {
  ...
  iframe.style.left = '-10000px'; // Off-screen but visible to browser engine
  iframe.style.top = '0';
...
const InventoryList: React.FC<InventoryListProps> = ({ items, categories, onAddItem, onUpdateItem, onDeleteItem }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const finalItem: InventoryItem = {
      ...
      // Ensure department is cast to correct type
      department: (formData.department || Department.STORE) as Department,
